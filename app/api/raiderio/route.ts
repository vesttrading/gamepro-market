...
export async function GET(request: NextRequest) {
  ...
  const raiderIoUrl =
    https://raider.io.{realm}&name=${name}`;/api/v1/characters/profile?region=eu&realm=${realm}&name=${name}&fields=mythic_plus_scores_by_season:current,raid_progression;
